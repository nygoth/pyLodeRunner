...
# На предыдущем шаге была реализована анимация блоков уровня с возможностью указывать продолжительность анимации
# и паузу между актами анимации. Реализована возможность для сокровищ генерировать паузу между анимациями
# случайным образом, так, чтобы они мерцали не все одновременно.

# На этом шаге приступаем к реализации ИИ монстров. Но сначала разобьём наш файл на несколько модулей.
# Модуль основной программы, модуль блоков и модуль персонажей
