...
# Перемещение игрока сделано. Да, пока всё это дёргано и есть косяк с прыжком персонажа, но главное --
# мы получили автоматическое падение, ползание по лестницам и перекладинам, контроль пространства.
# И даже чудовища падают на пол.
# Следующая задача -- плавное перемещение фигурок и сбор сокровищ
